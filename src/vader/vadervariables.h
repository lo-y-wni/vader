...
const char VV_RH[]          = "relative_humidity"; // dimensionless (0 <= RH <= 1)
const char VV_WATER_TYPE_RTTOV[] = "water_type";   // 0 (fresh), 1 (sea)
const char VV_SURF_TYPE_RTTOV[] = "surface_type";  // 0 (land), 1 (water), 2 (sea-ice)
const char VV_SFC_LANDMASK[]   = "landmask";       // 0 (sea), 1 (land)
