...
const oops::Variables AirDensityLevelsMinusOne_B::
...
oops::Variable AirDensityLevelsMinusOne_B::product() const
{
    return oops::Variable("air_density_levels_minus_one");
}

oops::Variables AirDensityLevelsMinusOne_B::ingredients() const
{
...
void AirDensityLevelsMinusOne_B::executeNL(atlas::FieldSet & afieldset)
{
...
void AirDensityLevelsMinusOne_B::executeTL(atlas::FieldSet & afieldsetTL,
...
void AirDensityLevelsMinusOne_B::executeAD(atlas::FieldSet & afieldsetAD,
                                      const atlas::FieldSet & afieldsetTraj)
{
